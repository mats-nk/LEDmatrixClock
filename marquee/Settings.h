...
******************************************************************************
 * This is designed for the ESP8266, suggestion Wemos D1 but other ESP8266 boards work as well.
 * - ESP8266 and minimum 4M flash
 * - MAX7219 LED Dot Matrix Module 4-in-1 Display (FC16)
 *   https://www.electroduino.com/max7219-4-in-1-led-dot-matrix-display-module-functions/
 * - 5 volt power supply
******************************************************************************
...
// Hardware wiring
//******************************
// Display wiring    CLK -> D5 (SCK)  GPIO14 on ESP8266
...
// #define BUZZER_PIN  D2         // Uncomment define BUZZER pin when BUZZER is installed

#define CONFIG "/conf.txt"        // Configuration file

//******************************
// Default Settings (no need to change; these can be set Web interface)
//******************************
...
int wideClockStyle = 1;                // 1=HH:MM, 2=HH:MM:SS, 3=HH:MM *CF, 4=HH:MM %RH, 5=mm dd HH:MM, 6=HH:MM mmdd, 7=HH:MM ddmm, 8=HH:MM WwwDD
                                       // (or HH:MM Www DD on >= 10 tile display)
...
#if COMPILE_MQTT
// Add scrolling messages with MQTT
